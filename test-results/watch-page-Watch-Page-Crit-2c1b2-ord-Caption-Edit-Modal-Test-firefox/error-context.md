  ...
  - generic [ref=e3]:
    ...
    - iframe [ref=e28]:
      - generic "YouTube Video Player" [ref=f1e3]:
        - generic [ref=f1e5]:
          - link "Photo image of Music Brokers" [ref=f1e8] [cursor=pointer]:
          ...
          - link "Covers Of Popular Songs - 100 Hits" [ref=f1e11] [cursor=pointer]:
            - /url: https://www.youtube.com/watch?v=ytwpFJ1uZYY
          - generic [ref=f1e12]:
            - button "Watch later" [ref=f1e13] [cursor=pointer]:
              - generic [ref=f1e14] [cursor=pointer]:
                - img
              - generic [ref=f1e15] [cursor=pointer]: Watch later
            - button "Share" [ref=f1e16] [cursor=pointer]:
              - generic [ref=f1e17] [cursor=pointer]:
                - img
              - generic [ref=f1e18] [cursor=pointer]: Share
        - button "Play" [ref=f1e21] [cursor=pointer]:
          - img
        - link "Watch on YouTube" [ref=f1e22] [cursor=pointer]:
          ...
          - generic [ref=f1e23] [cursor=pointer]: Watch on
