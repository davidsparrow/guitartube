      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleEmailSignUp}>
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="acceptedTerms" className="ml-2 block text-sm text-gray-400">
              I agree to the{' '}
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full inline-flex justify-center py-2 px-4 border border-gray-700 rounded-md shadow-sm bg-gray-800 text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
